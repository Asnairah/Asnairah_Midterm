...
<head>
    ...
    <style>
        ...
        header { background: black; color: gray; padding: 15px; text-align: center; }
        nav a { color: dark blue; text-decoration: none; margin: 0 15px; }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; background: white; }
        th, td { padding: 10px; border: 1px solid #ccc; text-align: left; }
        th { background-color: black; color: gray; }
        form { background: gray; padding: 20px; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); }
